    ...
    if (page === 'word') {
      ...
      openSubpage('听力训练', `
        ...
        <div class="card">
          ...
          <a href="https://www.bilibili.com/video/BV1E9HPzEE5X" target="_blank" rel="noopener" class="btn-outline" style="width:100%;margin-top:8px;display:block;text-align:center;">跳转原视频 ↗</a>
        </div>
